    ...
    <div class="theory-create-form w-50 m-auto">
        <form action="{{route('words.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4">
                ...
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <input type="text" class="form-control @error('words_title') is-invalid @enderror" name="words_title"  value="{{old('words_title')}}">
            </div>
            <div class="form-group mt-4">
                <label for="">Theory title</label>
                @error('image')
            ...
            <div class="form-group mt-4">
                ...
                <textarea name="words"  id="" cols="30" rows="10" class="form-control @error('words') is-invalid @enderror">
                    {{old('words')}}
                </textarea>
            </div>
