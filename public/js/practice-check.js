...
window.onload = function () {
  var exercises_box = $('.exercises-box'),
  ...
  var practiceForms = $('.exercises-box form'),
      i = 0,
      buttonToggle = true; //show first form

  $(practiceForms[i]).fadeIn(); //checking practice answers
    ...
    if (buttonToggle !== false) {
      ...
      axios.post('http://english-teacher.ua/theory-practice-check', {
        ...
        if (server_response.status === 'wrong' || server_response.status === 'finished') {
          var inps = $(practiceForms[i]).find($('.form-control'));

          for (var f = 0; f < inps; f++) {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/practice-check.js");
